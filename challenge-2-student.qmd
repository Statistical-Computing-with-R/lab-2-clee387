...
library(ggplot2)
ggplot(data=data, mapping=aes(x=species, y=weight, color=genus))+ geom_boxplot(outlier.shape = NA)+ geom_jitter( alpha=0.5)+labs(x="Species Names", y="Weight in grams",title= "Boxplots")+theme(axis.text.x=element_text(angle=45))
